...
<main>
    <!-- Section Héro -->
    <section class="hero" style="background-image: url('http://sae301selma.local/wp-content/uploads/2024/11/img1-1.png');">
        <h1>AUDALEAGUE</h1>
    ...
    <section class="about">
        ...
        <img src="http://sae301selma.local/wp-content/uploads/2024/11/img2.png" alt="À propos d'Audaleague" class="about-image" />
    </section>
    ...
    <section class="experience">
        ...
        <div class="features">
            <div class="feature">
                ...
                <img src="http://sae301selma.local/wp-content/uploads/2024/11/Group.png" alt="Graphiques Dynamiques" class="feature-image" />
                <p>Visualisez vos performances grâce à des graphiques et des analyses détaillées.</p>
            </div>
            <div class="feature">
                <h3>Récompenses Exclusives</h3>
                <img src="http://sae301selma.local/wp-content/uploads/2024/11/game-2.png" alt="Récompenses Exclusives" class="feature-image" />
                <p>Participez à des tournois pour gagner des récompenses réservées à notre communauté.</p>
            </div>
            <div class="feature">
                <h3>Accessibilité Totale</h3>
                <img src="http://sae301selma.local/wp-content/uploads/2024/11/microchip-2.png" alt="Accessibilité Totale" class="feature-image" />
...
<section id="tournaments" class="tournaments">
    ...
    <div class="tournament-carousel">
        <div class="tournament-card">
            <img src="http://sae301selma.local/wp-content/uploads/2024/11/img3.png" alt="THE WINNER TOURNAMENT" class="tournament-image" />
        ...
        <div class="tournament-card">
            <img src="http://sae301selma.local/wp-content/uploads/2024/11/img1-1.png" alt="TOURNOI 2" class="tournament-image" />
            <h3>TOURNOI 2</h3>
            <p>Participez à des tournois passionnants où vous pourrez défier les meilleurs joueurs.</p>
            <p>Nombre de participants : 4/5</p>
        </div>
        <div class="tournament-card">
            <img src="http://sae301selma.local/wp-content/uploads/2024/11/img9.png" alt="TOURNOI 3" class="tournament-image" />
            <h3>TOURNOI 3</h3>
            <p>Participez à des tournois passionnants où vous pourrez défier les meilleurs joueurs.</p>
            <p>Nombre de participants : 3/5</p>
        </div>
        <div class="tournament-card">
            <img src="http://sae301selma.local/wp-content/uploads/2024/11/img8.png" alt="TOURNOI 4" class="tournament-image" />
            <h3>TOURNOI 4</h3>
            <p>Participez à des tournois passionnants où vous pourrez défier les meilleurs joueurs.</p>
            <p>Nombre de participants : 5/5</p>
        </div>
        <div class="tournament-card">
            <img src="http://sae301selma.local/wp-content/uploads/2024/11/tournament-image5.png" alt="TOURNOI 5" class="tournament-image" />
            <h3>TOURNOI 5</h3>
            <p>Participez à des tournois passionnants où vous pourrez défier les meilleurs joueurs.</p>
            <p>Nombre de participants : 5/5</p>
        </div>
